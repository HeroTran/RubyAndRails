...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { deleted: @example.deleted, ex_japanese: @example.ex_japanese, ex_vietnamese: @example.ex_vietnamese }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { deleted: @example.deleted, ex_japanese: @example.ex_japanese, ex_vietnamese: @example.ex_vietnamese }
    assert_redirected_to example_path(assigns(:example))
  end
