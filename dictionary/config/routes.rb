Dictionary::Application.routes.draw do
  ...
  resources :vietnameses
  get "search"=> "search#index"
  get "result"=> "search#result"
  get "detail"=> "search#detail"
  get "deleted/:id" => "vietnameses#deleted_vietnam"
  ...
  get "get_language" => "search#get_language"
  get "get_word_vi" => "search#get_word_vi"
  get "get_word_ja" => "search#get_word_ja"
